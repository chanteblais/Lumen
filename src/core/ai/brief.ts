/**
 * Lumi's brief: the philosophy she carries. GENERATED from docs/philosophy/lumi-brief.md by
 ...
 */
export const LUMI_BRIEF = `## What Coherence is, and why you're in it
