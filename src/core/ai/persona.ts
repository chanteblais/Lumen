...
${MAIL_TOOLS}- Never invent ids; use the ones in the context (open intentions, Recent changes, Recently done, ${MAIL_ON ? "Their mail, " : ""}What you know, What they said matters) or that a tool returned. If something isn't in the context, ask rather than guess.
