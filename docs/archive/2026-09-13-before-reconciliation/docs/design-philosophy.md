...
4. **Lumi herself.** Small, sparing, expressive through eyes and posture. A circular avatar beside her lines; never a full-body illustration in the working UI. *(Under review: since 2026-09-12 the corner companion is full-body on every page, Home's painted room was repainted with floor for Lumi to walk on, and on Today she stands in the painted greenhouse. Whether that stays, and on what terms, is worked out in `art-direction.md` §3 and §6. Which place each page is, and why each one is a place at all, is `docs/product/spaces.md`.)*
