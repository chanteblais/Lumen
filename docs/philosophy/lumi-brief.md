...
| `docs/living/decisions.md` | `86253d5650ff` |
...
- **2026-09-18 · reviewed, nothing for Lumi** (`ux/today-at-a-glance`): the product decisions gained *Today gives the day at a glance; Right now leads it instead of taking the page*. The places line still reads true: Today is still a path with one thing first, not a pile, and turning the first thing down or breaking it into steps still happens right there. What changed is how much of the page the first thing takes, and that what's done today shows faintly. Both are about the page, not about what she should understand or say. The open tension with the Garden's §4 is Chanté's to settle on the desk; if she softens it, the places line may want "leads" wording then. Re-stamped.
