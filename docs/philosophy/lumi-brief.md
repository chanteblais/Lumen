...
| `docs/living/decisions.md` | `2266dde28a9a` |
...
- **2026-09-13 · reviewed, nothing for Lumi** (`fix/ai-and-routes`): the product decisions gained *Their word has to be theirs, and forgotten stays forgotten* (code review B4). It's enforcement in code — a quote must carry what they meant, and a forgotten thread isn't refiled on their words — of what the brief already says: what they told you outranks what you inferred. `brief.ts` regenerated byte-identical.
