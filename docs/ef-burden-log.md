...
|---|---|---|---|---|---|
| 2026-09-12 | Rewards: earning and spending coherence (contested, not built; `docs/living/decisions.md`) | count, choose | A coherence balance to see, and plants or things for Lumi to choose to spend it on | Conflicts with Product Vision §14 ("inhabited, not gamified", growth not points), which would need neither the balance nor the choice. If kept: only ever positive, earned for showing up as well as doing, spending never required. `docs/living/open-questions.md` 14, 6–7 | open |
