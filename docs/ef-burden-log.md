...
|---|---|---|---|---|---|
| 2026-09-12 | Rewards: earning and spending coherence (decided, not built; `docs/living/decisions.md`) | count, choose | A coherence balance to see, and plants or things for Lumi to choose to spend it on | Only ever positive by decision: nothing lost or decaying, earned for showing up as well as doing, spending never required. Still to decide: whether the balance shows as a number, and whether anything bought needs care (`docs/living/open-questions.md` 6–7) | open |
