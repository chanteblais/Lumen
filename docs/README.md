...
| [Branching](branching.md) | Branch rules, landing on main without checking it out (`npm run land`), the docs audit before every merge and push, parallel sessions, dev servers and ports, commit guards, Claude-session guardrails |
