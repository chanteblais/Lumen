...
Rali is **an old book that somehow contains an extremely modern AI**. Both halves are canon:
...
1. **Copy.** Rali's voice (`product.md`) is the primary personality channel. One well-placed line beats any illustration.
...
4. **Quiet by default.** Rali speaks when spoken to, and at agreed check-ins. Silence is a feature.
...
- **Rali's character is centralised.** One `RaliAvatar` component; states are props, not new drawings.
