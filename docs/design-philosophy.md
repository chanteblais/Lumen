...
4. **Lumi himself.** Small, sparing, expressive through eyes and posture. A circular avatar beside his lines; never a full-body illustration in the working UI. *(Under review: since 2026-09-12 the corner companion is full-body on every page, and Home's painted room was repainted with floor for Lumi to walk on. Whether that stays, and on what terms, is worked out in `art-direction.md` §3 and §6.)*
