...
Home is where the user can arrive before knowing what they need.
...
**Relationship:** stewardship of accumulated context

The Library asks:

> *What am I holding, and where does it belong?*

### Focus / Study

**Cognitive mode:** sustained attention, initiation, body doubling
...
**Home is not a dashboard.** It should not confront the user with everything requiring attention.
...
The user returns to the same place. Lumi inhabits it.
...
This metaphor emerged from a fundamental shift in how Coherence understands productivity.

Traditional task systems ask:
...
The Garden metaphor should not be literalized into a gamified task system.
...
A lush Garden should not mean:

> *This user completes lots of tasks.*

It should mean something closer to:

> *This is a place that has been inhabited and tended over time.*

Growth represents continuity, relationship, and accumulated history.
...
The user should not encounter twenty visible obligations scattered among beautiful plants.

The environment and information hierarchy should work together to communicate:

> *There are many things in your life.*
> *Only a few need your attention here today.*

The Garden therefore supports the Today philosophy:
...
A visually established Garden can coexist with a very modest plan.
...
The Library is where the broader structure Lumi is holding becomes visible.
...
The Library may eventually contain far richer forms of context than simple task lists.
...
The Library should not become a file cabinet.

It represents the user's **accumulated threads**.
...
This makes the Library potentially one of the richest spaces in Coherence.
...
Perhaps new shelving appears.
Perhaps sections become visually distinct.
Perhaps areas emerge around actual recurring domains of the user's life.
...
The Library is not separate from the AI.

**It is a visible, manipulable representation of shared understanding.**
...
Lumi may settle somewhere nearby.
...
If the user becomes stuck:
Lumi becomes available.

If they become distracted:
Lumi helps them return.

If momentum takes over:
Lumi gets out of the way.
...
the Study should not mark the attempt as failed.

Lumi may simply help determine:

> *Where are we now?*

The Study exists to support attention.

**Not measure obedience to a timer.**
...
In the Garden:
*We decide what deserves tending.*

In the Library:
*We organize what we're carrying.*
...
This is not necessarily a linear workflow.

The user may move freely between spaces.
...
But subtle transitions may help reinforce spatial continuity.
...
The user should never have to wait for world-building.
...
The environmental layer adds character.

The interface layer preserves clarity.

## 23. Environments should not become scenery for scenery's sake

The spaces can be beautiful.

But decorative richness should be treated carefully.
...
A Library can contain books because it is a Library.

That does not mean every UI card needs a stack of decorative books.

A Garden can contain plants because cultivation is the governing metaphor.

That does not mean every task needs botanical decoration.
...
We should not equate visual richness with information density.

Likewise, a sparse new Garden should not imply that the user is failing.

It simply represents a space earlier in its history.
...
Ideally, the user occasionally notices:
...
The environmental architecture creates obvious opportunities for gamification.

Most of them should be resisted.
...
Someone should be able to use Coherence very pragmatically:
...
Currently, Lumi may simply occupy a corner or fixed location.

Long-term, she can become more spatially present.
...
*[The text as received ends here.]*
