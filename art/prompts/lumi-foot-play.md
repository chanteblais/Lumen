...
|---|---|---|---|---|---|---|---|
| 2026-09-13 04:56 | v1 | gpt-image-2.5-sunburst · high · 1776x896 | `v1-2.5-sunburst-0913-045624-1.png` | 24 in 3 rows / 24 | 5084 / 4138 (run) | $0.04 | **pass, subtle** — heights 254–257, rows within 1%, head IoU ≥ 0.983 except the look up's first step (16→17, 0.965). The hood holds and only the eyes lower, eased: 165 → 156 → 149 → 148 → 147 → 145px above the feet over frames 2–7; up again in two ~10px steps (17, 19). The foot lifts rather than scuffs out (visible in 10, 11, 13–16), small at page size. **Approved by Chanté** (2026-09-13, beside candidate 4 at 160 ms: "gif 2 feels smoother") → `art/lumi/lumi-foot-play.png` |
