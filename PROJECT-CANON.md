...
| **Garden** (Today) | *What matters today?* | Tend: *what needs tending now?*, not *what remains incomplete?* Plant, tend, let rest, prune (V§15) | `/today`: over the painted greenhouse, Lumi's words on the painting, one Right now card and a faint slip with the rest of the path; Lumi stands in it on wide screens |
