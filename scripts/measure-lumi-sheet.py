"""Measure a new Lumi animation sheet before cutting it.
    ...
    python3 scripts/measure-lumi-sheet.py art/<sheet>.png [out-dir]
...
make the figure as tall as the breath rest frame of art/lumi-slow-idle.png.
...
REF = os.path.join(ROOT, 'art', 'lumi-slow-idle.png')
