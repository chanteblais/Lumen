...
public/lumi-heads.webp (the chat avatar's six heads, lossless).
...
public/lumi-heads.webp (lossless) is one row of six 176px squares, the hood 172px wide with
...
OUT_HEADS = os.path.join(ROOT, 'public', 'lumi-heads.webp')
...
Image.fromarray(heads, 'RGBA').save(OUT_HEADS, lossless=True, quality=100, method=6, exact=True)  # lossless: the avatar needs its exact pixels and alpha
